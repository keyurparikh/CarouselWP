...
import * as strings from 'CarouselWpWebPartStrings';

import { ICarouselWPWebPartProps } from './ICarouselWPWebPartProps';
...
export interface ICarouselWPWebPartProps {
  description: string;
}

export default class CarouselWpWebPart extends BaseClientSideWebPart<ICarouselWPWebPartProps> {
